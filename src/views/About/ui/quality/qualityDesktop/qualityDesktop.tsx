  ...
  const highlightKeywords = (text: string, keywords: string[]): string => {
    ...
    keywords.forEach((keyword) => {
      ...
      modifiedText = modifiedText.replace(
        regex,
        `<span class="${styles.localSpan}">$1</span>`,
      );
    });
    return modifiedText;
  };
      ...
      <div className={styles.container}>
          ...
          {itemsToShow.map((item, index) => (
            <div
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: highlightKeywords(item.title, item.titleKeywords),
                }}></div>
              <div
                className={styles.itemBody}
                dangerouslySetInnerHTML={{
                  __html: highlightKeywords(item.body, item.keywords),
                }}></div>
            </div>
          ))}
        </div>
        <div className={styles.arrows}>
          <div className={styles.arrowsPart}>
            <div className={styles.toTheLeft} onClick={prevItems}>
              →
            </div>
            <Divider
              width="55%"
            ...
            />
            <div className={styles.toTheLeft} onClick={nextItems}>
              ←
            </div>
          </div>
        </div>
