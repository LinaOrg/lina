...
const items: Item[] = [
    {
        ...
        keywords: [ "بهترین ماشین‌آلات","تجهیزات تمام اتوماتیک","تضمین","تولید محصول با بهترین کیفیت.","روغن فاقد اسیدهاي چرب ترانس"," داراي اسیدهاي چرب مهم","و ضروري امگا","بدون مواد نگهدارنده"],
    ...
    },
    {
        ...
        keywords: ["طبیعی بتاکاروتن" , "اولین اسنک لینا" , "لینا لوبیایی" , "اما لینا ناامید نشد..."],
    ...
    },
    {
        ...
        keywords: ["بازارهاي جهانی، صادرات به کشورهاي همسایه، حوزه خلیج فارس و اروپا را از آغاز شد." , "پاپریکا و با نام «لینا توپی»" , "اولین" ,"سرشار از رنگدانه‌هاي طبیعی کاروتنوئید و آنتی اکسیدان"],
    ...
    },
    {
        ...
        keywords: ["باکیفیت و خلق برندي شناخته‌شده" , "پرفروش‌ترین اسنک‌ها" , "اولین اسنک با رنگ طبیعی"],
        titleKeywords: [" "]
    },
];

export const QualityDesktop: React.FC = () => {
    const [currentIndex, setCurrentIndex] = useState<number>(0);
    const [selectedItem, setSelectedItem] = useState<Item>(items[0]);

    const itemsToShow = items.slice(currentIndex, currentIndex + 4);
        ...
        <>
            <div className={styles.container}>
                <div className={styles.title}>
                    <Title>
                        <span className={styles.title} dangerouslySetInnerHTML={{ __html: highlightKeywords(selectedItem.title, selectedItem.titleKeywords) }}></span>
                    </Title>
                </div>
